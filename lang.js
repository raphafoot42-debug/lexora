...
const I18N = {
  fr: {
    ...
    "dash.dashboard.nodata": "Pas encore de données.",
    ...
    "dash.stats.best_day": "Meilleur jour",
    ...
    "dash.profile.error_length": "6 caractères minimum.",
    "dash.profile.error_mismatch": "Les mots de passe ne correspondent pas.",
    "dash.profile.error_generic": "Une erreur est survenue.",
  ...
  en: {
    ...
    "dash.dashboard.nodata": "No data yet.",
    ...
    "dash.profile.error_length": "6 characters minimum.",
    "dash.profile.error_mismatch": "Passwords don't match.",
    "dash.profile.error_generic": "Something went wrong.",
